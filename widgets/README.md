...
### Редактор статей на вашем сайте удаляет тег виджета. 
  Если вы столкнулись с такой проблемой, оберните тег виджета Сравни в тег script следующим образом (на примере микровиджета):
    ```
